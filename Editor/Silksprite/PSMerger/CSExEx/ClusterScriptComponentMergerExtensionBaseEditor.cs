...
{
    [CustomEditor(typeof(ClusterScriptComponentMergerExtensionBase), true)]
    public class ClusterScriptComponentMergerExtensionBaseEditor : Editor
    {
        ...
        {
            var ext = (ClusterScriptComponentMergerExtensionBase)obj.targetObject;
